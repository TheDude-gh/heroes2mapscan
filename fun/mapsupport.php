...
class StringConvert {
	...
	//proprietary conversion to standard ascii and w1251 for russian
	public function Convert($text) {
		return strtr($text, $this->map);
	}

	/*
	//from ISO-8859-2 to UTF
	public function w1250_to_utf8($text) {
		return html_entity_decode(mb_convert_encoding(strtr($text, $this->map), 'UTF-8', 'ISO-8859-2'), ENT_QUOTES, 'UTF-8');
	}
	*/
}
